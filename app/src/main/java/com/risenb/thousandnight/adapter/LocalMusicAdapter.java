 ...
 * ================================================
 */
public class LocalMusicAdapter<T extends Object> extends BaseRecyclerAdapter<T> {
    ...
    protected BaseViewHolder loadView(Context context, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_local_music, null);
