...
public class MineHomeDynamicAdapter<T extends Object> extends BaseRecyclerAdapter {
    ...
    protected BaseViewHolder loadView(Context context, int i) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_mine_home_dynamic, null));
    }
