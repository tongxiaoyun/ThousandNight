...
import com.risenb.thousandnight.adapter.HomeDownloadListAdapter;
...
public class DownloadListUI extends BaseUI {
    ...
    private HomeDownloadListAdapter<Object> downloadListAdapter;
    ...
    private void initAdapter() {
        ...
        downloadListAdapter = new HomeDownloadListAdapter<>();
        downloadListAdapter.setActivity(this);
        xrv_download.setAdapter(downloadListAdapter);
    }
