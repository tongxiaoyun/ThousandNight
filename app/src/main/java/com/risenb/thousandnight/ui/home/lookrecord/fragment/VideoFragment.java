...
public class VideoFragment extends BaseFragment {
    ...
    private HomeVideoRecordAdapter<Object> homeVideoRecordAdapter;
    ...
    private void initAdapter() {
        ...
        homeVideoRecordAdapter = new HomeVideoRecordAdapter<>();
        homeVideoRecordAdapter.setActivity(getActivity());
        xrv_common.setAdapter(homeVideoRecordAdapter);
    }
}